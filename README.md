...
```
```bash
PYTHONPATH=/home/dataset-local/Epona:$PYTHONPATH torchrun --nnodes=1 --nproc_per_node=8 scripts/train_deepspeed.py   --batch_size 1   --lr 2e-5   --exp_name "train-nuplan-test"   --config configs/dit_config_dcae_nuplan.py   --resume_path "pretrained/epona_nuplan.pkl"   --eval_steps 2000
```
